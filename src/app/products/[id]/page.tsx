    ...
    <main className="min-h-screen bg-zinc-950 px-6 py-8 lg:px-8">
      <div className="mx-auto flex max-w-7xl flex-col gap-8">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
          <ProductDetailCard product={formattedProduct} />
          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-6 backdrop-blur">
            ...
            <Link
              href="/products"
              className="mt-8 inline-flex items-center gap-2 text-sm font-medium text-brand-300 transition hover:text-white"
            >
              Back to catalog
            </Link>
          </div>
